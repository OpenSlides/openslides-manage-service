...
func (c *manageClient) CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*CreateUserReply, error) {
...
func (UnimplementedManageServer) CreateUser(context.Context, *CreateUserRequest) (*CreateUserReply, error) {
